...
void SPI_MSTransfer_T4_OPT::test()
{
...
SPI_MSTransfer_T4_FUNC
void SPI_MSTransfer_T4_OPT::begin()
{
...
SPI_MSTransfer_T4_FUNC
uint16_t SPI_MSTransfer_T4_OPT::transfer16(uint16_t* buffer, uint16_t length, uint16_t packetID)
{
...
SPI_MSTransfer_T4_FUNC
uint32_t SPI_MSTransfer_T4_OPT::events()
{
    if (mstqueue.size())
    {
